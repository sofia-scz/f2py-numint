...
! ----------------------------------
! solve ivp until tf is reached

! declarations
subroutine endtime_ivp(dealgo, tf, dt, x0, v0)
use constants
implicit none
integer,intent(in) :: dealgo
real*8,intent(in) :: tf, dt
...
! declarations
subroutine npoints_ivp(dealgo, npoints, dt, x0, v0)
use constants
implicit none
